...
exports.config = {
    ...
    baseUrl: (env.IS_SMOKE_TEST) ? 'https://chrisguttandin.github.io/web-audio-meetup-march-2017' : `http://localhost:${ projects[defaultProject].targets.serve.options.port }`,

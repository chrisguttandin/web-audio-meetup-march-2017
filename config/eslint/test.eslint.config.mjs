...
export default defineConfig([
    ...
    },
    {
        files: ['**/*.ts'],
        rules: {
            '@angular-eslint/component-selector': ['error', { prefix: 'wam', style: 'kebab-case', type: 'element' }],
            '@angular-eslint/directive-selector': ['error', { prefix: 'wam', style: 'camelCase', type: 'attribute' }],

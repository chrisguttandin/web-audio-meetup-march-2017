        ...
        'csp-production': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: () => {
                        const html = fs.readFileSync('build/web-audio-meetup-march-2017/index.html', 'utf-8'); // eslint-disable-line node/no-sync
        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: (_, filename, extension) => grunt.file.expand({ cwd: 'build/web-audio-meetup-march-2017', ext: extension }, `assets/${ filename }.*`)[0]
                }, {

...
module.exports = (grunt) => {
    return {
        'csp-production': {
            files: {
                './': ['build/web-audio-meetup-march-2017/browser/**/index.html']
            },
            options: {
                patterns: [
                    {
        ...
        'manifest': {
            files: {
                './': ['build/web-audio-meetup-march-2017/browser/ngsw.json']
            },
            options: {
                patterns: [
                    {
                    ...
                    },
                    {
                        ...
                        replacement: (_, filename) => {
                            return `"/web-audio-meetup-march-2017/browser/${filename}.html": "${computeHashOfFile(
                                `build/web-audio-meetup-march-2017/browser/${filename}.html`,
                                'sha1',
                                'hex'
                            )}"`;
                        }

module.exports = {
    ...
    build: {
        cmd: "ng build --aot --base-href /web-audio-meetup-march-2017 --build-optimizer false --no-sourcemap --prod --stats-json && webpack-stats-duplicates build/stats.json --whitelist 'multi ./node_modules/prismjs' && rm build/stats.json"
    },
    continuous: {
        cmd: 'ng test'
    },
